          ...
          <CardContent>
            {loading ? (
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p className="mt-4 text-muted-foreground">{t.trackingPage.loading}</p>
              </div>
            ) : error || !report ? (
              <div className="text-center py-12">
                <XCircle className="h-12 w-12 text-red-500 mx-auto mb-4" />
                <p className="text-red-500 font-medium text-lg">{t.trackingPage.notFound}</p>
              ...
              <div className="space-y-8">
                <div className={`p-6 rounded-lg border ${getStatusColor(report.status)}`}>
                  <div className="flex items-start gap-4">
                    {getStatusIcon(report.status)}
                    <div className="flex-1">
                      <h3 className="font-semibold text-lg mb-1">
                        {t.statusLabels[report.status as keyof typeof t.statusLabels]}
                      </h3>
                      <p className="text-sm">{getStatusDescription(report.status)}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6 pt-4">
                  <h3 className="font-medium border-b pb-2">
                    {language === "tr" ? "Bildirim Detayları" : "Report Details"}
                  </h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <p className="text-sm font-medium text-muted-foreground mb-1">
                        {language === "tr" ? "Bildirimde Bulunan" : "Reported By"}
                      </p>
                      <p className="font-medium">
                        {report.name
                          ? report.name
                    ...
                    <div className="md:col-span-2">
                      <p className="text-sm font-medium text-muted-foreground mb-1 flex items-center gap-2">
                        ...
                        {language === "tr" ? "Şirket ile Bağlantı" : "Connection to Company"}
                      </p>
                      <p className="font-medium">{getConnectionLabel(report.connection_option)}</p>
                    </div>
                    ...
                    <div className="md:col-span-2">
                      <p className="text-sm font-medium text-muted-foreground mb-1">
                        {language === "tr" ? "Bildirim İçeriği" : "Report Content"}
                      </p>
